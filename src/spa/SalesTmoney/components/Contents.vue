<template>
    <div class="contents-wrap">
        <div class="top-box">
            <div class="row">
                <div class="item">
                    ...
                    <span class="title">최근 1일 티머니 매출</span>
                </div>
                <div class="item">
                    <span class="price">242,900원</span>
                    <span class="title">최근 7일 티머니 매출</span>
                </div>
                <div class="item">
                    <span class="price">1,695,200원</span>
                    <span class="title">최근 30일 티머니 매출</span>
                </div>
                <div class="item">
        ...
        <div class="contents">
            <div class="date_row">
                <span class="title">Tmoney Sales</span>
                <span class="date_box">
...
export default {
    ...
    mounted() {
        let tmoney_chart = this.$refs.tmoney_chart;
        let tmoney_chart_obj = new Chart(tmoney_chart, this.tmoney_chart_data);
